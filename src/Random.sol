...
// import "./ERC721.sol";
// import "lib/openzeppelin-contracts/contract/token/ERC721/ERC721.sol";
...
contract Random is ERC721, VRFConsumerBaseV2 {
    ...
    constructor(
        uint64 s_subId
    ) VRFConsumerBaseV2(vrfCoordinator) ERC721("WTF Random", "WTF") {
